...
{
       0,   430,   430,   432,   434,   435,   437,   439,   440,   441,
     443,   445,   446,   448,   449,   450,   451,   452,   453,   454,
     455,   456,   457,   458,   459,   461,   462,   464,   465,   467,
     468,   469,   470,   476,   477,   478,   479,   480,   481,   482,
     484,   485,   486,   488,   489,   491,   492,   494,   495,   497,
     498,   500,   501,   503,   504,   505,   507,   508,   510,   511,
     512,   514,   515,   516,   517,   518,   519
};
#endif
...
#line 430 "latte.y" /* yacc.c:1652  */
    { (yyval.program_) = make_Prog((yyvsp[0].listtopdef_)); YY_RESULT_Program_= (yyval.program_); }
#line 1693 "parser.c" /* yacc.c:1652  */
    break;

  case 3:
#line 432 "latte.y" /* yacc.c:1652  */
    { (yyval.topdef_) = make_FnDef((yyvsp[-5].type_), (yyvsp[-4].string_), (yyvsp[-2].listarg_), (yyvsp[0].block_));  }
...
#line 480 "latte.y" /* yacc.c:1652  */
    { (yyval.expr_) = make_EApp((yyvsp[-3].string_), (yyvsp[-1].listexpr_));  }
